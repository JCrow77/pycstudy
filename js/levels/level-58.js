LEVELS[58] = { id:58, title:"综合项目：飞船状态面板", phase:"综合实战", icon:"🖥️",
  ...
  story:"构建飞船状态面板。<br><br>预填字典：<code>systems = {\"生命维持\": 65, \"导航\": 82, \"通讯\": 45, \"推进器\": 90, \"护盾\": 30}</code><br><br>要求：<br>① 用 <code>for name, val in systems.items()</code> 遍历<br>② 每个系统用if/elif/else判断：>=80→\"正常\"、>=50→\"警告\"、<50→\"危险\"<br>③ 用f-string打印每行，格式如 <code>生命维持: 65% 正常</code><br>④ 用变量 <code>danger</code> 统计危险系统数量（初始=0）<br>⑤ 用一个空 <code>print()</code> 输出空行，然后打印危险系统数量",
