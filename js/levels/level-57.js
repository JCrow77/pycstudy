LEVELS[57] = { id:57, title:"综合项目：生存天数计算器", phase:"综合实战", icon:"⏰",
  ...
  story:"计算四种物资各自能撑多少天，取最小值作为最终生存天数。<br><br>要求：<br>① 定义函数 <code>calc_days(stock, daily, reserve=0)</code>，返回 <code>(stock - reserve) / daily</code><br>② 分别计算：氧气 <code>calc_days(1200, 50)</code>、食物 <code>calc_days(90, 3)</code>、水 <code>calc_days(200, 8)</code>、燃料 <code>calc_days(500, 30, 200)</code><br>③ 四个结果存入列表 <code>days</code><br>④ 用 <code>min(days)</code> 取最小值<br>⑤ 用 f-string 依次打印每种物资的天数（取整 <code>:.0f</code>）和\"最短生存: X天\"",
